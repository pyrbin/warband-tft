...
// #FB_TODO: readd functionality for stat(value) & clamp/round derives.
...
//                 Self {
//                     #value_field: #clamp_fn(self.#value_field),
//                     ..*self
//                 }
//             }
...
//                 Self {
//                     #value_field: #round_fn(self.#value_field),
//                     ..*self
//                 }
//             }
//         }
...
//     // Default to identity function if the functions aren't provided
//     let clamp_fn = clamp_fn
//         .map(|ident| quote!(#ident))
//         .unwrap_or_else(|| quote!(|v: f32| v));
